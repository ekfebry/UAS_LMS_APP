  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/class_dashboard': (context) => const ClassDashboardScreen(),
        '/material_detail': (context) => const MaterialDetailScreen(),
        '/assignment_detail': (context) => const AssignmentDetailScreen(title: 'Assignment'),
